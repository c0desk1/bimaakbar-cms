...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to Bima Akbar.
...
- __Website__ refers to Bima Akbar, accessible from [https://bimaakbar.my.id](https://bimaakbar.my.id)
...
- By email: contact@bimaakbar.my.id
